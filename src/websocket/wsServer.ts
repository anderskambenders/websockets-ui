...
import { REQUEST_TYPE, RESPONSE_TYPE, WebsocketRequest, WebsocketResponse } from "../types";
import Users from "../model/user";
import getResponse from "../controller/response";

const wsConnections: { connectionId: string; userName: string; ws: WebSocket }[] = [];

const getWsEntryIndexByKey = (key: "connectionId" | "userName", value: string) => {
